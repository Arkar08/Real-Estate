...
export const UpdateUser = ({ initialData }: UpdateUserProps) => {
  const [role, setRole] = useState<string>(initialData?.role || "Agent");
  ...
  const [formData, setFormData] = useState<UserData>({
    fullName: initialData?.fullName || "Aung Aung",
    email: initialData?.email || "aungaung@gmail.com",
    phone: initialData?.phone || "09123456789",
    status: initialData?.status || "Active",
    role: initialData?.role || "Agent",
    licenseNumber: initialData?.licenseNumber || "LIC-987654321",
    agencyName: initialData?.agencyName || "Golden Real Estate Co.",
      ...
      <div className="flex items-center justify-between border-b pb-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Edit details, change permissions, or update status for this account.
          </p>
        </div>
        <Button
          variant="outline"
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-4 rounded-lg border bg-card p-6 shadow-sm">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6 pt-2">
            <div className="relative group w-28 h-28 rounded-full border-2 border-dashed border-muted-foreground/30 flex items-center justify-center overflow-hidden bg-muted/40 shrink-0">
              {imagePreview ? (
                <>
                  <img
                    src={imagePreview}
            ...
            <div className="space-y-2 text-center sm:text-left">
              ...
              <div className="flex flex-wrap items-center justify-center sm:justify-start gap-3">
                ...
                >
                  <Upload className="h-4 w-4" /> Choose New Photo
                </Button>
